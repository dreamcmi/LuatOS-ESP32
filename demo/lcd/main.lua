...
-- lcd.init("gc9a01",{port = "device",pin_dc = 6, pin_pwr = 10,pin_rst = pin.PB03,direction = 0,w = 240,h = 320,xoffset = 0,yoffset = 0},spi_lcd)
...
-- lcd.init("st7735",{port = "device",pin_dc = 6, pin_pwr = 10,pin_rst = pin.PB03,direction = 0,w = 128,h = 160,xoffset = 2,yoffset = 1},spi_lcd)
...
-- lcd.init("st7789",{port = "device",pin_dc = 6, pin_pwr = 10,pin_rst = pin.PB03,direction = 0,w = 240,h = 240,xoffset = 0,yoffset = 0},spi_lcd)
...
lcd.init("st7735s",{port = "device",pin_dc = 6, pin_pwr = 10,pin_rst = pin.PB03,direction = 2,w = 160,h = 80,xoffset = 0,yoffset = 0},spi_lcd)
